...
// TODO: Add mui box and inside add mui buton, code taken from EventLayout
const CreateActionButton: React.FunctionComponent<CreateActionButtonProps> = ({
  event,
}) => {
